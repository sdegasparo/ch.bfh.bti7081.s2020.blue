...
public class Achievement {
  ...
  @Id
  @GenericGenerator(name = "achievement_id_seq", strategy = PostgreSQLConstants.SEQUENCE_GENERATOR_STRATEGY, parameters = {@Parameter(name = "sequence_name", value = "achievement_id_seq"), @Parameter(name = "increment_size", value = "1")})
