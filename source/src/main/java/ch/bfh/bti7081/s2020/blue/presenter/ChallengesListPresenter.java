...
public class ChallengesListPresenter implements ChallengesListViewListener {

  private final ChallengesListView view;
  private final ChallengeService challengeService;

  public ChallengesListPresenter(ChallengesListView view, BeanInjector beanInjector) {
    this.view = view;
  ...
  public void onChallengeAccept(Long challengeId) {
    ...
    view.navigateToCurrentChallenges();
  }
}
