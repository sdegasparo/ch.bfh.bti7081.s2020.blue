...
import ch.bfh.bti7081.s2020.blue.presenter.RegisterPresenter;
...
@Route(value = RegisterViewImpl.ROUTE)
@PageTitle("Register")
public class RegisterViewImpl extends FormLayout implements RegisterView {
  ...
  public RegisterViewImpl() {
    ...
    listener = new RegisterPresenter(registerDto, this);
